/* 
*  In this program we have to tell whether a given number is trimorphic or not.
*  A trimorphic number is a number whose cube's last digit is equal to the
   last digit of the number itself.
*   For Ex:  
           If number=10
               cube=1000
